...
%   The following macros allows setting editor's notes
%   in the following paragraph with a dagger symbol rather
%   than the numbers reserved for notes in the original
%   document.  \edNoteBegin and \edNoteEnd must be used
%   in pairs (with no nesting) to preserve the number
%   sequence of the original footnotes.
...
\footnote{
    {\sf Editor's note:  In the 1923 English
    translation, the quantities ``$\zeta$'' and ``$\xi$'' were
...
\frac{1}{c}\dd{}{\tau}\left\{\beta\left({\rm Y}-\frac{v}{c}{\rm N}\right)\right\} & = & \dd{\rm L}{\zeta} & - \dd{}{\xi}\left\{\beta\left({\rm N}-\frac{v}{c}{\rm Y}\right)\right\}, \\
...
\vspace{2ex}
{\sf
This edition of Einstein's {\em On the Electrodynamics of Moving
Bodies} is based on the English translation of his original
1905 German-language paper (published as
{\em Zur Elektrodynamik bewegter K\"orper},
in {\em Annalen der Physik}. {\bf 17}:891, 1905) which appeared in
the book {\em The Principle of Relativity}, published in 1923 by
Methuen and Company, Ltd.\ of London.  Most of the papers in that
collection are English translations from the German
{\em Das Relativatsprinzip}, 4th ed., published by in 1922
by Tuebner.  All of these sources are now in the public
domain; this document, derived from them, remains in
the public domain and may be reproduced in any manner
or medium without permission, restriction, attribution, or
compensation.

Numbered footnotes are as they appeared in the 1923 edition;
editor's notes are marked by a dagger ({\rm \dag}) and appear in
{\sf sans serif} type.  The 1923 English translation modified
the notation used in Einstein's 1905 paper to conform to that
in use by the 1920's; for example, {\em c} denotes the speed of
light, as opposed the {\rm V} used by Einstein in 1905.
