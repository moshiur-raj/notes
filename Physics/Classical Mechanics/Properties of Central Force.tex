...
\indent These can also be proven using the potential energy function~\eqref{eq:potential energy} and conservation of angular momentum using cross product~\eqref{eq:conserv L vec analysis} without the need of lagrangian mechanics.
...
\indent Equation~\eqref{eq:eomII} establises a relation between $1/r$ and $\theta$. There is no other variable (e.g.\ time) in this equation. This means instead of figuring the path of the particle from the force, we can do the reverse and calculate the force from the path!!!
